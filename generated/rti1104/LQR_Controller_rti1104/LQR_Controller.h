...
#ifndef RTW_HEADER_LQR_Controller_h_
#define RTW_HEADER_LQR_Controller_h_
#include <string.h>
...
struct P_LQR_Controller_T_ {
  ...
  real_T DiscreteTimeIntegrator_IC;    /* Expression: 0
                                        * Referenced by: '<Root>/Discrete-Time Integrator'
                                        */
  real_T kI_Gain;                      /* Expression: 109.545
                                        * Referenced by: '<Root>/kI'
                                        */
  real_T k1_Gain;                      /* Expression: 96.1531
                                        * Referenced by: '<Root>/k1'
                                        */
  real_T k2_Gain;                      /* Expression: 2.128
  ...
  real_T Gain2_Gain;                   /* Expression: pi/180
                                        ...
                                        */
  real_T Gain4_Gain;                   /* Expression: 15
...
/* Zero-crossing (trigger) state */
extern PrevZCX_LQR_Controller_T LQR_Controller_PrevZCX;
...
extern void LQR_Controller_output(void);
extern void LQR_Controller_update(void);
 ...
 *
 * '<Root>' : 'LQR_Controller'
 * '<S1>'   : 'LQR_Controller/DS1104ENC_POS_C1'
 * '<S2>'   : 'LQR_Controller/DS1104ENC_SETUP'
 * '<S3>'   : 'LQR_Controller/DS1104ENC_SET_POS_C1'
 * '<S4>'   : 'LQR_Controller/DS1104SL_DSP_PWM'
 * '<S5>'   : 'LQR_Controller/Function 1'
 * '<S6>'   : 'LQR_Controller/Function 2'
 * '<S7>'   : 'LQR_Controller/RTI Data'
 * '<S8>'   : 'LQR_Controller/RTI Data/RTI Data Store'
 * '<S9>'   : 'LQR_Controller/RTI Data/RTI Data Store/RTI Data Store'
 * '<S10>'  : 'LQR_Controller/RTI Data/RTI Data Store/RTI Data Store/RTI Data Store'
 */
#endif                                 /* RTW_HEADER_LQR_Controller_h_ */
