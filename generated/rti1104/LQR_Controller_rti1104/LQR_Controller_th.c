/************************ dSPACE target specific file *************************
   ...
   Include file .\LQR_Controller_rti1104\LQR_Controller_th.c :

   Task Configuration file for model : LQR_Controller

   RTI1104 7.16 (02-May-2021)/2.20
   01-May-2026 21:58:42
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\LQR_Controller_rti1104\LQR_Controller_th.c is for ST).
# endif
