...
MATLAB_ROOT_ALT                = C:\PROGRA~1\MATLAB\R2021a
MATLAB_BIN_ALT                 = C:\PROGRA~1\MATLAB\R2021a\bin
RELEASE_VERSION                = R2021a
RELEASE_VERSION               := $(RELEASE_VERSION,S'\.'_',W_,LC,S'^r'')
COMPUTER                       = PCWIN64
MODEL                          = DI_FB_Controller
MODULES                        = DI_FB_Controller_data.c DI_FB_Controller_trc_ptr.c rt_zcfcn.c
S_FUNCTIONS                    = 
S_FUNCTIONS_LIB                = 
SOLVER                         = 
NUMST                          = 2
...
RTWCUST_INCLUDES = \
	"$(START_DIR)" \
	"$(START_DIR)\DI_FB_Controller_rti1104" \
