/*********************** dSPACE target specific file *************************
   ...
   Include file DI_FB_Controller_rti.c:
...
#define RTB_STRUCTURE_NAME             DI_FB_Controller_B
#define RTP_STRUCTURE_NAME             DI_FB_Controller_P
...
static void rti_mdl_initialize_io_boards(void)
{
  ...
  ds1104_slave_dsp_pwm_init(0, 1.0/ 10000, 0.5, SLVDSP1104_PWM_MODE_SYM,
  ...
  ds1104_slave_dsp_pwm_init(0, 1.0/ 10000, 0.5, SLVDSP1104_PWM_MODE_SYM,
    SLVDSP1104_PWM_POL_LOW, SLVDSP1104_PWM_CH2_MSK);
  ...
  ds1104_slave_dsp_pwm_init(0, 1.0/ 10000, 0.5, SLVDSP1104_PWM_MODE_SYM,
    SLVDSP1104_PWM_POL_LOW, SLVDSP1104_PWM_CH4_MSK);
...
__INLINE void rti_mdl_sample_input(void)
{
  ...
  DI_FB_Controller_B.SFunction1 = (real_T) ds1104_inc_position_read(1,
    DS1104_INC_LINE_SUBDIV_4);

  /* dSPACE I/O Board DS1104 #1 Unit:ENC_POS Group:DPOS */
  DI_FB_Controller_B.SFunction2 = (real_T) ds1104_inc_delta_position_read(1,
    DS1104_INC_LINE_SUBDIV_4);
}
