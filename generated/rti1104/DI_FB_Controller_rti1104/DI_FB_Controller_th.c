/************************ dSPACE target specific file *************************
   ...
   Include file .\DI_FB_Controller_rti1104\DI_FB_Controller_th.c :

   Task Configuration file for model : DI_FB_Controller

   RTI1104 7.16 (02-May-2021)/2.20
   01-May-2026 21:52:08

   MATLAB 9.10.0.2015706 (R2021a) Update 7
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\DI_FB_Controller_rti1104\DI_FB_Controller_th.c is for ST).
# endif
